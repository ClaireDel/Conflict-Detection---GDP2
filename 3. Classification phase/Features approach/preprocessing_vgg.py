...
# Training
DIRECTORY_TRAIN = "/Users/clair/Desktop/data_crop_black/" # with normal and fight

# Validation
DIRECTORY_TEST = "/Users/clair/Desktop/data_crop_black/" # with normal and fight
...
graph.text(0, 200, values[0], fontsize=15, ha = 'center')
graph.text(1, 100, values[1], fontsize=15, ha = 'center')
